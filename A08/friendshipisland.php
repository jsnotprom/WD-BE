...
islandcontents.islandOfPersonalityID WHERE islandsofpersonality.islandOfPersonalityID = 2;";
...
$content1 = "SELECT content FROM `islandcontents` WHERE islandContentID = 8";
$result1 = executeQuery($content1);
while ($row = mysqli_fetch_assoc($result1)) {
  $contentdesc1 = $row['content'];
}

$content2 = "SELECT content FROM `islandcontents` WHERE islandContentID = 9";
$result2 = executeQuery($content2);
while ($row = mysqli_fetch_assoc($result2)) {
  $contentdesc2 = $row['content'];
}

$content3 = "SELECT content FROM `islandcontents` WHERE islandContentID = 10";
...
<head>
  ...
  <title>JSG's Friendship Island</title>
  ...
  <style>
    ...
    .bgimg {
      ...
      background-image: url('images/friendshipisland.png');
      min-height: 100%;
    }
  </style>
</head>
      ...
      <div class="w3-row-padding" style="margin:0 -16px">
        <div class="w3-half">
          ...
          <div class="w3-container">
            <img src="images/friendshipislandcore1.png" style="width:100%">
            <p class="w3-center w3-text-black"> 
            <br> <?php echo $contentdesc1; ?>
            </p>
          </div>
          <div class="w3-container">
            <img src="images/friendshipislandcore2.png" style="width:100%">
            <p class="w3-center w3-text-black">
        ...
        <div class="w3-half">
          <div class="w3-container">
            <img src="images/friendshipislandcore3.png" style="width:100%">
            <p class="w3-center w3-text-black">
