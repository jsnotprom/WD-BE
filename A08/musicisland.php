...
islandcontents.islandOfPersonalityID WHERE islandsofpersonality.islandOfPersonalityID = 4;";
...
$content1 = "SELECT content FROM `islandcontents` WHERE islandContentID = 14";
$result1 = executeQuery($content1);
while ($row = mysqli_fetch_assoc($result1)) {
  $contentdesc1 = $row['content'];
}

$content2 = "SELECT content FROM `islandcontents` WHERE islandContentID = 15";
$result2 = executeQuery($content2);
while ($row = mysqli_fetch_assoc($result2)) {
  $contentdesc2 = $row['content'];
}

$content3 = "SELECT content FROM `islandcontents` WHERE islandContentID = 16";
...
<head>
  ...
  <style>
    ...
    .bgimg {
      ...
      background-image: url('images/musicisland.png');
      min-height: 100%;
    }
  </style>
</head>
      ...
      <div class="w3-row-padding" style="margin:0 -16px">
        <div class="w3-half">
          ...
          <div class="w3-container">
            <img src="images/musicislandcore3.png" style="width:100%">
            <p class="w3-center w3-text-black"> 
            <br> <?php echo $contentdesc1; ?>
            </p>
          </div>
          <div class="w3-container">
            <img src="images/musicislandcore1.png" style="width:100%">
            <p class="w3-center w3-text-black">
        ...
        <div class="w3-half">
          <div class="w3-container">
            <img src="images/musicislandcore2.png" style="width:100%">
            <p class="w3-center w3-text-black">
