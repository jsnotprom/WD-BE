...
islandcontents.islandOfPersonalityID WHERE islandsofpersonality.islandOfPersonalityID = 1;";
...
$content1 = "SELECT content FROM `islandcontents` WHERE islandContentID = 5";
$result1 = executeQuery($content1);
while ($row = mysqli_fetch_assoc($result1)) {
  $contentdesc1 = $row['content'];
}

$content2 = "SELECT content FROM `islandcontents` WHERE islandContentID = 6";
$result2 = executeQuery($content2);
while ($row = mysqli_fetch_assoc($result2)) {
  $contentdesc2 = $row['content'];
}

$content3 = "SELECT content FROM `islandcontents` WHERE islandContentID = 7";
...
<head>
  ...
  <title>JSG's Family Island</title>
  ...
  <style>
    ...
    .bgimg {
      ...
      background-image: url('images/familyisland.png');
      min-height: 100%;
    }
  </style>
</head>
      ...
      <div class="w3-row-padding" style="margin:0 -16px">
        <div class="w3-half">
          ...
          <div class="w3-container">
            <img src="images/familyislandcore1.png" style="width:100%">
            <p class="w3-center w3-text-black"> 
            <br> <?php echo $contentdesc1; ?>
            </p>
          </div>
          <div class="w3-container">
            <img src="images/familyislandcore2.png" style="width:100%">
            <p class="w3-center w3-text-black">
        ...
        <div class="w3-half">
          <div class="w3-container">
            <img src="images/familyislandcore3.png" style="width:100%">
            <p class="w3-center w3-text-black">
